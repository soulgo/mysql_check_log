...
$(document).ready(function() {
    ...
    // !! 确认 renderActivitiesTable 函数的正确性 !!
    function renderActivitiesTable(activities) {
        ...
        activities.forEach(act => {
            ...
            // let rowClass = ''; // 行背景色可以省略，让徽章更突出

            switch (riskLevel) {
                case 'High': badgeClass = 'risk-badge-high'; break;
                case 'Medium': badgeClass = 'risk-badge-medium'; break;
                case 'Low': badgeClass = 'risk-badge-low'; break;
            }

            // 构建表格行 HTML - 再次确认这里没有错误的注释
            const row = `
                <tr> 
